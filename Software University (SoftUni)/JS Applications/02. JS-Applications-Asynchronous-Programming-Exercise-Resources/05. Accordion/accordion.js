async function solution() {
    ...
    async function toggle(ev){
        const accordion = ev.target.parentNode.parentNode; //gives accordion as its two parents above button
 
        const p = ev.target.parentNode.parentNode.children[0].children[0]; //goes to accordion then takes child of child at 0 index
